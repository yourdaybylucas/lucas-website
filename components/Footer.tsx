    ...
    return (
        <footer className="relative z-10 bg-lucas-navy text-lucas-cream border-t border-lucas-slate/20">
            <div className="max-w-[1400px] mx-auto">
                {/* The Ledger Grid - compressed padding */}
                <div className="grid grid-cols-1 lg:grid-cols-5 border-l border-lucas-slate/20">
                    
                    {/* Col 1 & 2: The Manifesto & Sign-off */}
                    <div className="col-span-1 lg:col-span-2 border-r border-b lg:border-b-0 border-lucas-slate/20 p-6 md:p-8 flex flex-col justify-between min-h-[280px]">
                        <div>
                            {/* Logo: Container scaled down to match tighter layout */}
                            <div className="relative w-full max-w-[200px] md:max-w-[240px] h-8 md:h-12 overflow-hidden flex items-center mb-6">
                    ...
                    {/* Col 3: The Index */}
                    <div className="col-span-1 border-r border-b lg:border-b-0 border-lucas-slate/20 p-6 md:p-8 flex flex-col hover:bg-lucas-slate/5 transition-colors duration-slow">
                        <span className="font-sans text-[10px] tracking-zissou uppercase text-lucas-slate mb-8 block">
                            [ The Index ]
                        </span>
                        <nav className="flex flex-col gap-4 font-sans text-xs tracking-widest uppercase">
                    ...
                    <div className="col-span-1 border-r border-lucas-slate/20 p-6 md:p-8 flex flex-col hover:bg-lucas-slate/5 transition-colors duration-slow">
                        <span className="font-sans text-[10px] tracking-zissou uppercase text-lucas-slate mb-8 block">
                            [ Currently ]
                        </span>
